...
```ruby
  ...
  db.execute("INSER INTO numbers VALUES ( ?, ? )", ['one', 1])
  db.execute("INSER INTO numbers VALUES ( ?, ? )", ['two', 2])
  db.execute("INSER INTO numbers VALUES ( ?, ? )", ['three', 3])


  # Find all rows in numbers table
